...
const getWeather = () => {
    const promise = new Promise((reslove, reject) => {
        fetch('http://api.k780.com/?app=weather.realtime&weaid=984&ag=today&appkey=46331&sign=34051141f822d25503341f09b38ec58b&format=json')
            .then(res => res.json())
            .then(data => {
            ...
            .catch(err => {
                reject(new Error('getWeather error'))
            })
    })
    return promise
}
